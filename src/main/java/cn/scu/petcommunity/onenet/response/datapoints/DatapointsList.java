package cn.scu.petcommunity.onenet.response.datapoints;
...
public class DatapointsList {
	...
	@JsonCreator
	public DatapointsList(@JsonProperty("count") String count,
			@JsonProperty("datastreams") ArrayList<DatastreamsItem> devices) {
		super();
		this.count = count;
		this.devices = devices;
	}
	...
	public static class DatastreamsItem {
		...
		@JsonCreator
		public DatastreamsItem(@JsonProperty("id") String id,
				@JsonProperty("datapoints") List<DatapointsItem> datapoints) {
			super();
			this.id = id;
			this.datapoints = datapoints;
		}
